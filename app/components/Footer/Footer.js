    ...
    <footer className={styles.container}>
      <div className={styles.innerContainer}>
        ...
        <div className={`${styles.section} ${styles.right}`}>
          <Link to={'http://ec.europa.eu/index_en.htm'} className={styles.logoContainer} target="_blank">
            <img src={commissionLogo} alt="European Commission" className={styles.logo} />
          </Link>
          <Link to={'http://www.europarl.europa.eu/portal/en'} className={styles.logoContainer} target="_blank">
